...
public enum ErrorCode {
    ...
    AI_REPORT_PDF_EXPORT_NOT_FOUND(HttpStatus.NOT_FOUND, "AI 리포트 PDF 내보내기 정보를 찾을 수 없습니다."),
    AI_REPORT_PDF_NOT_READY(HttpStatus.CONFLICT, "AI 리포트 PDF가 아직 준비되지 않았습니다."),
    AI_REPORT_PDF_GENERATE_FAILED(HttpStatus.INTERNAL_SERVER_ERROR, "AI 리포트 PDF 생성에 실패했습니다."),
    AI_REPORT_PDF_DOWNLOAD_FAILED(HttpStatus.BAD_GATEWAY, "AI 리포트 PDF 다운로드 URL 생성에 실패했습니다."),
