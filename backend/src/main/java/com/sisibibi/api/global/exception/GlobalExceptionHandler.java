...
public class GlobalExceptionHandler {
    ...
    private static final String AI_REPORTS_ROOM_ID_UNIQUE_CONSTRAINT = "uk_ai_reports_room_id";
    ...
    private ErrorCode resolveDataIntegrityViolationErrorCode(DataIntegrityViolationException e) {
        ...
        if (isConstraintViolation(e, SPEECH_REPORTS_SPEECH_REPORTER_UNIQUE_CONSTRAINT)) {
            return ErrorCode.SPEECH_REPORT_ALREADY_EXISTS;
        }

        if (isConstraintViolation(e, AI_REPORTS_ROOM_ID_UNIQUE_CONSTRAINT)) {
            return ErrorCode.AI_REPORT_ALREADY_EXISTS;
        }
