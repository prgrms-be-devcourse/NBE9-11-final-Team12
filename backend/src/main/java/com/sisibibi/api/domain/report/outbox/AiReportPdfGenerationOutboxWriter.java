...
public class AiReportPdfGenerationOutboxWriter {

    private static final String AGGREGATE_TYPE = "AI_REPORT_PDF_EXPORT";
    private static final String DEDUPLICATION_KEY_PREFIX = "AI_REPORT_PDF_GENERATION_REQUESTED:";
    ...
    public void record(Long exportId, LocalDateTime requestedAt) {
        ...
        outboxEventRepository.save(OutboxEvent.pending(
                AGGREGATE_TYPE,
                exportId,
                OutboxEventType.AI_REPORT_PDF_GENERATION_REQUESTED,
                payload(exportId),
                deduplicationKey,
                requestedAt
        ));
    ...
    private String payload(Long exportId) {
        try {
            ...
            throw new IllegalStateException("Failed to serialize AI report PDF generation request.", exception);
        }
    }
}
